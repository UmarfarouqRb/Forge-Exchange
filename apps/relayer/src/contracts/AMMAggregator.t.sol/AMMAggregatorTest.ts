...
export interface AMMAggregatorTestInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "IS_TEST"
      | "excludeArtifacts"
  ...
  encodeFunctionData(
    functionFragment: "test_GetBestQuote",
    values?: undefined
  ): string;
...
export interface AMMAggregatorTest extends BaseContract {
  connect(runner?: ContractRunner | null): AMMAggregatorTest;
  waitForDeployment(): Promise<this>;

  interface: AMMAggregatorTestInterface;
  ...
  test_GetBestQuote: TypedContractMethod<[], [void], "view">;
  ...
  getFunction(
    nameOrSignature: "test_GetBestQuote"
