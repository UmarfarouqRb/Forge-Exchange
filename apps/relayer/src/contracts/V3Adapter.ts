...
export interface V3AdapterInterface extends Interface {
  getFunction(
    nameOrSignature: "quote" | "quoter" | "router" | "swap"
  ): FunctionFragment;
...
export interface V3Adapter extends BaseContract {
  connect(runner?: ContractRunner | null): V3Adapter;
  waitForDeployment(): Promise<this>;

  interface: V3AdapterInterface;
