...
export interface MinimalUniswapUniversalRouterAdapterTestInterface
  extends Interface {
  getFunction(
    nameOrSignature:
      | "IS_TEST"
  ...
  encodeFunctionData(
    functionFragment: "test_minimalSwap",
    values?: undefined
  ): string;
...
export interface MinimalUniswapUniversalRouterAdapterTest extends BaseContract {
  connect(
    runner?: ContractRunner | null
  ): MinimalUniswapUniversalRouterAdapterTest;
  waitForDeployment(): Promise<this>;

  interface: MinimalUniswapUniversalRouterAdapterTestInterface;
  ...
  test_minimalSwap: TypedContractMethod<[], [void], "nonpayable">;
  ...
  getFunction(
    nameOrSignature: "test_minimalSwap"
  ): TypedContractMethod<[], [void], "nonpayable">;
