...
export default function Deposit() {
  ...
  const handleDeposit = async () => {
    ...
    const parsedAmount = parseUnits(amount, settlementToken.decimals);
    const hasSufficientWalletBalance = walletBalance && walletBalance.value >= parsedAmount;
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Button
                  ...
                  onClick={() => walletBalance && settlementToken && setAmount(formatUnits(walletBalance.value, settlementToken.decimals))}
                  disabled={!walletBalance || !settlementToken}
                >
                  Max
                </Button>
              </div>
