...
export interface AerodromeAdapterTestInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "IS_TEST"
      | "USDC"
  ...
  decodeFunctionResult(functionFragment: "test_quote", data: BytesLike): Result;
...
export interface AerodromeAdapterTest extends BaseContract {
  connect(runner?: ContractRunner | null): AerodromeAdapterTest;
  waitForDeployment(): Promise<this>;

  interface: AerodromeAdapterTestInterface;
  ...
  test_quote: TypedContractMethod<[], [void], "nonpayable">;
