...
export interface IntentSpotRouterNewTestInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "IS_TEST"
      | "excludeArtifacts"
  ...
  encodeFunctionData(
    functionFragment: "intentSpotRouter",
    values?: undefined
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "test_Deployment",
    values?: undefined
  ): string;
...
export interface IntentSpotRouterNewTest extends BaseContract {
  connect(runner?: ContractRunner | null): IntentSpotRouterNewTest;
  waitForDeployment(): Promise<this>;

  interface: IntentSpotRouterNewTestInterface;
  ...
  intentSpotRouter: TypedContractMethod<[], [string], "view">;
  ...
  test_Deployment: TypedContractMethod<[], [void], "nonpayable">;
  ...
  getFunction(
    nameOrSignature: "intentSpotRouter"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
  ...
  getFunction(
    nameOrSignature: "test_Deployment"
  ): TypedContractMethod<[], [void], "nonpayable">;
  getFunction(
