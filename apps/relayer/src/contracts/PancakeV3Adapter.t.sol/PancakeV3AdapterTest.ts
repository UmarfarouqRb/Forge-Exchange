...
export interface PancakeV3AdapterTestInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "IS_TEST"
      | "excludeArtifacts"
...
export interface PancakeV3AdapterTest extends BaseContract {
  connect(runner?: ContractRunner | null): PancakeV3AdapterTest;
  waitForDeployment(): Promise<this>;

  interface: PancakeV3AdapterTestInterface;
