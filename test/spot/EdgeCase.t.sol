...
contract EdgeCaseTest is Test {
    ...
    function test_CBBTC_to_WETH_Swap() public {
        ...
        uint256 userBalanceBefore = vault.balances(USER, WETH);
        uint256 feeBalanceBefore = vault.balances(MULTISIG, WETH);
        ...
        uint256 userBalanceAfter = vault.balances(USER, WETH);
        uint256 feeBalanceAfter = vault.balances(MULTISIG, WETH);
        ...
        console.log("Fee Collected (WETH):", feeCollected / 1e18);
        console.log("--------------------------");
    ...
    function _performAndLogSwap(
        ...
        uint256 feeBalanceBefore = vault.balances(MULTISIG, tokenOut);
        ...
        uint256 feeBalanceAfter = vault.balances(MULTISIG, tokenOut);
        ...
        console.log("Fee Collected:", feeCollected / (10**outDecimals));
    ...
    function test_USDC_to_AERO_Swaps() public {
        ...
        for (uint i = 0; i < amounts.length; i++) {
            ...
            _performAndLogSwap(USDC, AERO, 18, amounts[i], ad, swapData, header);
        }
        console.log("-----------------------------------------");
    }
    ...
    function test_USDC_to_DAI_Swaps() public {
        ...
        for (uint i = 0; i < amounts.length; i++) {
            string memory header = string(abi.encodePacked("Swap for ", vm.toString(amounts[i] / 10**6), " USDC:"));
            _performAndLogSwap(USDC, DAI, 18, amounts[i], ad, swapData, header);
        }
        console.log("-----------------------------------------------");
    }
    ...
    function test_USDC_to_TRUMP_Swaps() public {
        ...
        for (uint i = 0; i < amounts.length; i++) {
            string memory header = string(abi.encodePacked("Swap for ", vm.toString(amounts[i] / 10**6), " USDC:"));
            _performAndLogSwap(USDC, TRUMP, 18, amounts[i], multi, swapData, header);
        }
        console.log("------------------------------------------");
    }
    ...
    function test_USDC_to_SOL_Swaps() public {
        ...
        for (uint i = 0; i < amounts.length; i++) {
            string memory header = string(abi.encodePacked("Swap for ", vm.toString(amounts[i] / 10**6), " USDC:"));
            _performAndLogSwap(USDC, SOL, 9, amounts[i], multi, swapData, header);
        }
        console.log("----------------------------------------");
    }
}
