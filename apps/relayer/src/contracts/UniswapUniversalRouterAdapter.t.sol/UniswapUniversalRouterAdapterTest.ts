...
export interface UniswapUniversalRouterAdapterTestInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "IS_TEST"
      | "USDC"
...
export interface UniswapUniversalRouterAdapterTest extends BaseContract {
  connect(runner?: ContractRunner | null): UniswapUniversalRouterAdapterTest;
  waitForDeployment(): Promise<this>;

  interface: UniswapUniversalRouterAdapterTestInterface;
