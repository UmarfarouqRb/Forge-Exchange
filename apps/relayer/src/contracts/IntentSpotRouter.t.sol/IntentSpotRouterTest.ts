...
export interface IntentSpotRouterTestInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "IS_TEST"
      | "excludeArtifacts"
      ...
      | "targetSelectors"
      | "targetSenders"
      | "test_executeSwap_largeAmount_withFee"
      | "test_executeSwap_withProtocolFee"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_executeSwap_largeAmount_withFee",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_executeSwap_withProtocolFee",
    values?: undefined
  ): string;
...
export interface IntentSpotRouterTest extends BaseContract {
  connect(runner?: ContractRunner | null): IntentSpotRouterTest;
  waitForDeployment(): Promise<this>;

  interface: IntentSpotRouterTestInterface;
  ...
  test_executeSwap_largeAmount_withFee: TypedContractMethod<
    [],
    [void],
    "nonpayable"
  >;

  test_executeSwap_withProtocolFee: TypedContractMethod<
    [],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "test_executeSwap_largeAmount_withFee"
  ): TypedContractMethod<[], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "test_executeSwap_withProtocolFee"
  ): TypedContractMethod<[], [void], "nonpayable">;
