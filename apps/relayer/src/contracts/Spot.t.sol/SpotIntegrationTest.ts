...
export interface SpotIntegrationTestInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "IS_TEST"
      | "excludeArtifacts"
      ...
      | "targetSenders"
      | "test_Full_Swap"
      | "test_Full_Swap_With_Custom_Fee"
      | "test_Vault_Deposit_And_Withdraw"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_Full_Swap",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_Full_Swap_With_Custom_Fee",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_Vault_Deposit_And_Withdraw",
    values?: undefined
  ): string;
...
export interface SpotIntegrationTest extends BaseContract {
  connect(runner?: ContractRunner | null): SpotIntegrationTest;
  waitForDeployment(): Promise<this>;

  interface: SpotIntegrationTestInterface;
  ...
  test_Full_Swap: TypedContractMethod<[], [void], "nonpayable">;

  test_Full_Swap_With_Custom_Fee: TypedContractMethod<[], [void], "nonpayable">;

  test_Vault_Deposit_And_Withdraw: TypedContractMethod<
    [],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "test_Full_Swap"
  ): TypedContractMethod<[], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "test_Full_Swap_With_Custom_Fee"
  ): TypedContractMethod<[], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "test_Vault_Deposit_And_Withdraw"
  ): TypedContractMethod<[], [void], "nonpayable">;
