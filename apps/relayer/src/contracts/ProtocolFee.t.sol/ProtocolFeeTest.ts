...
export interface ProtocolFeeTestInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "IS_TEST"
      | "excludeArtifacts"
  ...
  encodeFunctionData(
    functionFragment: "test_CollectsProtocolFee",
    values?: undefined
  ): string;
...
export interface ProtocolFeeTest extends BaseContract {
  connect(runner?: ContractRunner | null): ProtocolFeeTest;
  waitForDeployment(): Promise<this>;

  interface: ProtocolFeeTestInterface;
  ...
  test_CollectsProtocolFee: TypedContractMethod<[], [void], "nonpayable">;
  ...
  getFunction(
    nameOrSignature: "test_CollectsProtocolFee"
  ): TypedContractMethod<[], [void], "nonpayable">;
