...
export interface VaultSpotInvariantTestInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "IS_TEST"
      | "deposit"
  ...
  encodeFunctionData(
    functionFragment: "invariant_solvency",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface VaultSpotInvariantTest extends BaseContract {
  connect(runner?: ContractRunner | null): VaultSpotInvariantTest;
  waitForDeployment(): Promise<this>;

  interface: VaultSpotInvariantTestInterface;
  ...
  deposit: TypedContractMethod<
    [user: AddressLike, tokenIndex: BigNumberish, amount: BigNumberish],
    [void],
    "nonpayable"
  >;

  emergencyWithdraw: TypedContractMethod<
    [user: AddressLike, tokenIndex: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  invariant_solvency: TypedContractMethod<[], [void], "view">;
  ...
  getFunction(
    nameOrSignature: "invariant_solvency"
