...
export interface UniswapV2AdapterTestInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "IS_TEST"
      | "USDC"
...
export interface UniswapV2AdapterTest extends BaseContract {
  connect(runner?: ContractRunner | null): UniswapV2AdapterTest;
  ...
  test_quote: TypedContractMethod<[], [void], "view">;
